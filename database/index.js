...
pool.getConnection((err, connection) => {
  ...
  //     const productQuery = 'INSERT INTO products (id, title, description, price, discountPercentage, rating, stock, brand, category, thumbnail) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
  //     const productValues = [
  //       product.id,
  //       product.title,
  //       product.description,
  ...
  //       product.thumbnail,
  //     ];
  //     connection.query(productQuery, productValues, (error, results) => {
  //       if (error) {
  //         reject('Error inserting product data: ' + error);
  //         return;
  //       }
  ...
  //   const imagePromises = [];
  //   const imagesQuery = 'INSERT INTO images (product_id, image_url) VALUES (?, ?)';
  //   for (const image of images) {
  //     const imageValues = [productId, image];
  //     const imagePromise = new Promise((resolve, reject) => {
  //       connection.query(imagesQuery, imageValues, (err, res) => {
  //         if (err) {
  //           reject('Error inserting image data: ' + err);
  //           return;
  //         }
  ...
  //       await insertImages(productId, product.images);
  //     } catch (error) {
  //       console.error(error);
  //     }
  //   }
